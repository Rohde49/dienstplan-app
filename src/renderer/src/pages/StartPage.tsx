...
function StartPage(): React.JSX.Element {
  return (
    <div className="mx-auto max-w-5xl p-6 sm:p-8 lg:p-10">
      <h1 className="mb-6 text-3xl font-bold tracking-tight">Planung der Dienstpläne</h1>
          ...
          >
            <Card className="h-full bg-muted/60">
              <CardHeader>
                ...
                <CardDescription className="leading-relaxed">{navCard.description}</CardDescription>
              </CardHeader>
            </Card>
          </Link>
        ))}
