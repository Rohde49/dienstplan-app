...
| [KW 34/2026](./2026-kw34.md) | 17.–23.08.2026 | Setup- und Konfigurationsprüfung vor Schritt 17: Datenbankstart abgesichert und Verdrahtung nach `index.ts` gezogen; `foreign_keys` eingeschaltet und Testdatenbank angeglichen; Migrationspfad angelegt; `sandbox: true` aktiviert und `window.electron` entfernt; `electron-builder.yml` vom Template auf das Projekt umgestellt; Fehleranzeige im Renderer eingeführt |
