...
- Die farbliche Hervorhebung von „Δ Soll/Ist" im ursprünglichen Mockup (grün bei `0:00`, sonst farblich abgesetzt) ist bewusst weiterhin nicht Teil von Schritt 11, für einen späteren Feinschliff zurückgestellt. Die textuelle Vorzeichen-Darstellung (`+`/`0:00`/`−`) wird in Schritt 11 korrekt umgesetzt.
